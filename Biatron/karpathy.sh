...
CHECKPOINT_PATH="/raid/aluno_daniel/projects/BIA-MEGATRON/karpathy/checkpoints"
TENSORBOARD_LOGS_PATH="/raid/aluno_daniel/projects/BIA-MEGATRON/karpathy/checkpoints/tensorboard_logs"
